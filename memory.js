...
const SEED_MEMORY = {
  ...
  'models/gemini-2.5': { val: 'Google DeepMind multimodal. Excels at code, reasoning, scientific analysis.', type: 'knowledge' },
  'models/chatgpt-5': { val: 'OpenAI GPT-5. State-of-art conversational AI. Comprehensive task completion.', type: 'knowledge' },
  'models/grok-3': { val: 'xAI real-time model. Live data streams, direct communication style.', type: 'knowledge' },
  'models/claude-4-opus': { val: 'Anthropic 200K context. Thoughtful, nuanced, safety-focused.', type: 'knowledge' },
  'models/ollama-local': { val: 'Privacy-first local execution. Custom fine-tuning. Self-hosted.', type: 'knowledge' },
